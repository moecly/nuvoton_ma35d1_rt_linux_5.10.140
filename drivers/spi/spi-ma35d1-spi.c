...
#else
		nuvoton->slave_txdone.lock           = (spinlock_t)__SPIN_LOCK_UNLOCKED(nuvoton->slave_txdone.lock);
#endif
...
#else
		nuvoton->slave_rxdone.lock           = (spinlock_t)__SPIN_LOCK_UNLOCKED(nuvoton->slave_rxdone.lock);
#endif
