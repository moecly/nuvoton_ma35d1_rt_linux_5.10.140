...
static inline unsigned int serial_in(struct uart_ma35d1_port *p,
									int offset)
{
	return __raw_readl(p->port.membase + offset);
}

static inline void serial_out(struct uart_ma35d1_port *p, int offset,
								int value)
{
...
static void ma35d1_prepare_RX_dma(struct uart_ma35d1_port *p)
{
	...
	pdma_rx->rxdesc = dmaengine_prep_slave_sg(pdma_rx->chan_rx,
						pdma_rx->sgrx, sg_loop, DMA_FROM_DEVICE,
...
static void ma35d1serial_set_mctrl(struct uart_port *port,
									unsigned int mctrl)
{
	struct uart_ma35d1_port *up = (struct uart_ma35d1_port *)port;
	unsigned int mcr = 0;
...
static void ma35d1serial_break_ctl(struct uart_port *port,
									int break_state)
{
	struct uart_ma35d1_port *up = (struct uart_ma35d1_port *)port;
	unsigned long flags;
...
static unsigned int ma35d1serial_get_divisor(struct uart_port *port,
											unsigned int baud)
{
	unsigned int quot;
...
static void
ma35d1serial_set_termios(struct uart_port *port,
...
static void
ma35d1serial_pm(struct uart_port *port, unsigned int state,
...
static int ma35d1serial_ioctl(struct uart_port *port,
